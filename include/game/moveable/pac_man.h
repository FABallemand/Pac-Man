...
private:
    ...
    /*static constexpr*/ SDL_Rect initial_sprite_{3, 89, S1_PACMAN_W, S1_PACMAN_H}; //!< Initial sprite
    /*static constexpr*/ DyingSprites dying_sprites_ = {SDL_Rect{3, 106, S1_PACMAN_W, S1_PACMAN_H}, SDL_Rect{22, 106, S1_PACMAN_W, S1_PACMAN_H},
